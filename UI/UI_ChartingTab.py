...
@author: Albreto Sepio
                ...
                This module is for CLOSING PRICE charting.
"""
...
class MainChart(QWidget):
    def __init__(self,StockSymbol,StockName,date_data,close_data,years):
        super().__init__()
        ...
        self.Chart_Close_Date(self.close_data,self.date_data)
    ...
    def Chart_Close_Date(self,close_prices,dates):
         self.close_prices = close_prices
         self.dates = dates
         self.sc.axes.plot(self.dates,self.close_prices)
         ...
         self.sc.axes.set_ylabel("Closing Price",font = "ARIAL",fontsize = 20)
